...
int main()
{
    ...
    unordered_map<string, Splay<dados>> tab;
    list<string> nome_das_colunas;
    unordered_map<string, vector<dados>> tab_vetor;
    ...
    cria_vetor(arq, tab_vetor, nome_das_colunas);
    cria_arvores(tab_vetor, tab, nome_das_colunas);
    ...
    // Destroi a arvore da memoria
    for(auto & it: nome_das_colunas){
        destroi_splay(tab[it]);
    }
